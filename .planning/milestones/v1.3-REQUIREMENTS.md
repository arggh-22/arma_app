# Requirements Archive: v1.3 Telegram Account Linking
...
- [x] **TGUI-01**: Home screen shows `Link` button with Telegram icon
  - Visible in dashboard/home flow
  - Opens Telegram linking screen on tap

- [x] **TGUI-02**: Linking screen provides full guided steps
...
- [x] **TGUI-03**: Linking screen shows clear result states
...
- [x] **TGREL-01**: Linking flow is resilient and test-covered
...
| TGUI-01 | Phase 14 | Complete |
| TGUI-02 | Phase 14 | Complete |
| TGUI-03 | Phase 15 | Complete |
| TGCOMP-01 | Phase 11 | Complete |
| TGREL-01 | Phase 15 | Complete |
