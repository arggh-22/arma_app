...
- ✅ **v1.3 Telegram Account Linking** — archived: `.planning/milestones/v1.3-ROADMAP.md` (shipped 2026-05-24, known gap accepted: TGAPI-01)
...
Archived: see `.planning/milestones/v1.3-ROADMAP.md` (completed phases 11–15; urgent 15.1 was planned but not executed before archival).
