...
/// Wraps the settings list so it reads as a proper desktop settings page:
/// on desktop the content is centered in a comfortable max-width column
/// instead of stretching edge-to-edge. On mobile it returns the child
/// unchanged (layout untouched).
class _AdaptiveSettingsBody extends StatelessWidget {
  const _AdaptiveSettingsBody({required this.child});

  final Widget child;

  static bool get _isDesktopUi {
