...
/// Unique identifier (UUID v4).
 ...
 String? get obfsPassword;/// ID of the subscription this config belongs to (null = manual import).
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,protocol,address,port,uuid,password,encryption,network,security,sni,host,path,alpn,fingerprint,flow,alterId,serviceName,authority,publicKey,shortId,spiderX,method,obfs,obfsPassword,subscriptionId,groupName,addedAt]);

@override
String toString() {
  return 'ServerConfig(id: $id, name: $name, protocol: $protocol, address: $address, port: $port, uuid: $uuid, password: $password, encryption: $encryption, network: $network, security: $security, sni: $sni, host: $host, path: $path, alpn: $alpn, fingerprint: $fingerprint, flow: $flow, alterId: $alterId, serviceName: $serviceName, authority: $authority, publicKey: $publicKey, shortId: $shortId, spiderX: $spiderX, method: $method, obfs: $obfs, obfsPassword: $obfsPassword, subscriptionId: $subscriptionId, groupName: $groupName, addedAt: $addedAt)';
}
...
switch (_that) {
case _ServerConfig() when $default != null:
return $default(_that.id,_that.name,_that.protocol,_that.address,_that.port,_that.uuid,_that.password,_that.encryption,_that.network,_that.security,_that.sni,_that.host,_that.path,_that.alpn,_that.fingerprint,_that.flow,_that.alterId,_that.serviceName,_that.authority,_that.publicKey,_that.shortId,_that.spiderX,_that.method,_that.obfs,_that.obfsPassword,_that.subscriptionId,_that.groupName,_that.addedAt);case _:
  return orElse();
