...
void main() {
  group('DeviceIdService', () {
    ...
    test(
      'returns stored device id when it matches stable platform id',
      () async {
    ...
    test(
      'stores and returns Android ID when no persisted value exists',
      () async {
        var platformCalls = 0;
        final service = DeviceIdService(
          datasource,
    ...
    test(
      'stores generated UUID fallback when platform id is unavailable',
      () async {
        var platformCalls = 0;
        var uuidCalls = 0;
        final service = DeviceIdService(
    ...
    test(
      'migrates legacy stored id to stable Android id when available',
      () async {
    ...
    test(
      'does not print plaintext identifiers while resolving device id',
      () async {
